...
from .profiles.evm_transaction import analyze_observation
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze a bounded EVM transaction observation through Try DDC v2.")
    parser.add_argument("--observation", required=True, type=Path)
    parser.add_argument("--out-dir", default="try-ddc-evm-tx-output", type=Path)
