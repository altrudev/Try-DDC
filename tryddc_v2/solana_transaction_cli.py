...
from .profiles.solana_transaction import analyze_observation
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze a bounded read-only Solana transaction observation.")
    parser.add_argument("--observation", required=True, type=Path)
    parser.add_argument("--out-dir", default="try-ddc-solana-transaction-output", type=Path)
